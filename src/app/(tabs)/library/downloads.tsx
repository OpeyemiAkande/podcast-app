...
import {DownloadedEpisode, useDownloadsStore} from "@/stores/useDownloadsStore";
...
function DownloadItem({episode}: {episode: DownloadedEpisode}) {
  ...
  const handleDelete = () => {
    Alert.alert("Remoce Download", `Delete "${episode.title}"?`, [
...
export default function DownloadsScreen() {
  ...
  return (
    <FlatList
      ...
      ListEmptyComponent={
        <View className="flex-1 h-100 items-center justify-center pt-20">
